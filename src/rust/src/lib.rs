...
pub mod chinese_remainder_theorem_extended_euclidean_gcd_reduce_i64;
pub mod chinese_remainder_theorem_extended_euclidean_gcd_reduce_usize;
...
pub mod chinese_remainder_theorem_garner;
pub mod choose;
pub mod cht;
...
pub mod garner_algorithm_composite_modular;
