...
pub mod binary_search_on_sequence_bisection_of_2_ok;
pub mod binary_search_on_sequence_bisection_of_ng_ok;
pub mod binary_tree;
...
pub mod euler_totient_with_trial_division;
...
pub mod fenwick_tree_with_commutative_monoid;
...
pub mod splay_tree_with_box_recurse;
pub mod split;
pub mod spqr_tree;
pub mod spreadsort;
...
pub mod union_find_potentialized_with_static_abelian_group_and_uf_trait;
